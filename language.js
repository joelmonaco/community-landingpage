...
const translations = {
  ...
  en: {
    ...
    kontaktModal: {
      ...
      checkboxLabel: 'I accept the <a href="/terms.html" target="_blank" rel="noopener">Terms</a> *',
      privacyLinkText: 'The data entered in this form is processed exclusively for the purpose of handling your report and combating abuse. The legal basis for processing is Art. 6(1)(f) GDPR (legitimate interest). You have the right to object to the processing of your personal data in accordance with Art. 21 GDPR. You can direct your objection through the known contact channels. An objection may result in the report no longer being processed. For more information on the processing of your personal data, please refer to the <a href="/privacy.html" target="_blank" rel="noopener">Privacy Policy</a>.',
